...
var PCDLoader = class extends Loader {
  ...
  parse(data) {
    ...
    function parseHeader(data2) {
      ...
      PCDheader2.version = /^VERSION (.*)/im.exec(PCDheader2.str);
      PCDheader2.fields = /^FIELDS (.*)/im.exec(PCDheader2.str);
      PCDheader2.size = /^SIZE (.*)/im.exec(PCDheader2.str);
      PCDheader2.type = /^TYPE (.*)/im.exec(PCDheader2.str);
      PCDheader2.count = /^COUNT (.*)/im.exec(PCDheader2.str);
      PCDheader2.width = /^WIDTH (.*)/im.exec(PCDheader2.str);
      PCDheader2.height = /^HEIGHT (.*)/im.exec(PCDheader2.str);
      PCDheader2.viewpoint = /^VIEWPOINT (.*)/im.exec(PCDheader2.str);
      PCDheader2.points = /^POINTS (.*)/im.exec(PCDheader2.str);
