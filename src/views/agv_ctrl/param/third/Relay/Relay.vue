<template>
    <div>
        <el-table :data="tableDataCrtlRelay" style="width: 100%" class="tableDataCrtlRelay">
            <el-table-column prop="name" label="⚠️ 继电器">
        ...
        <el-dialog :title="title" v-model="dialogVisible" :visible="dialogVisible" width="600px"
            :close-on-click-modal="false" class="edit-data-dialog" style="height: 32%;">
            <br>
...
<style>
.tableDataCrtlRelay .el-table__body tr:nth-child(2n) {
