        ...
        <el-card v-for="(item, index) in jsondata.SafetyLoop.Pls" :key="index" class="button-card"
            ...
            <div v-if="PLS_open[index]">
                ...
                <div v-if="item.type === 0">
                    ...
                    <el-card>
                        <el-button type="success" @click="addAreaOutput(index)"
                            style="margin-top: 10px;">添加切区</el-button>
                                ...
                                <el-card style="flex: 1; min-width: 150px; padding: 10px;">
                                    ...
                                    <div class="button-values">
                                        ...
                                        <div class="input-group" v-if="showModuleInputa(index, areaIndex)">
                                            ...
                                            <el-input v-if="isLocalIOa(index, areaIndex)"
                                                v-model.number="area.area_output[2]" placeholder="模块编号" type="number"
                                        ...
                                        <div class="input-group">
                                            ...
                                            <el-select v-if="isLocalIOa(index, areaIndex)" v-model="area.area_output[3]"
                                                ...
                                                <el-option v-for="num in Array.from({ length: 10 }, (_, i) => i)"
                                                    :key="num" :label="'bit' + num" :value="num" />
                                            </el-select>
                                            <el-input v-else-if="isGPIOa(index, areaIndex)"
                                                style="margin-right: 10px; width: 100px;"
                        ...
                        <el-card class="plscard">
                            ...
                            <div class="button-values">
                                ...
                                <div class="input-group">
                                    ...
                                    <label v-else>模块内输出点编号:</label>
                                    <el-select v-if="isLocalIO(index)" v-model="item.config.io.near[3]"
                                        placeholder="选择输出点" style="margin-right: 10px; width: 100px;">
                            ...
                            <div class="button-values">
                                ...
                                <div class="input-group">
                                    ...
                                    <el-input v-else-if="isGPIOfar(index)" style="margin-right: 10px; width: 100px;"
                                        v-model.number="item.config.io.far[3]"
                                        @change="formatbit5far(index)"></el-input>
            ...
            <br>
            <el-button @click="open_or_close(index)">展开/折叠</el-button>
        </el-card>
    </div>
...
const PLS_open = ref({});
const open_or_close = (index) => {
    PLS_open.value[index] = !PLS_open.value[index];
}
