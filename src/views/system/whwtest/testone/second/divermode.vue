        ...
        <div class="page-container main-view">
            ...
            <div class="table-box content-container page-content-box">
                ...
                <div class="left">
                    ...
                    <h3>⚠️ 车体模型</h3>
                    配置车体类型和轮舵机械参数:
                    <el-button @click="toggleagvmodel" type="text" plain :disabled="false">
                        <span v-if="!agvmodel">展开</span>
                        <span v-else>展开</span>
                        <span :class="{ 'rotate-arrow': agvmodel }">➡️</span>
                    </el-button><br>
...
import agvmodelh from './AGVmodel/AGVmodel.vue';

const dialogVisible = ref(false);
const manualparm = ref(false);
const autoparm = ref(false);
const agvmodel = ref(false);

const toggleagvmodel = () => {
    agvmodel.value = !agvmodel.value;
};
