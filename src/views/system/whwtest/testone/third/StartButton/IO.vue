...
const generateJSON = () => {
    if (selected.value === "1" || selected.value === "2" || selected.value === "4") {
        ...
        newRow.value.value = [parseInt(selected.value), parseInt(selectedcan.value), parseInt(selectedcan1.value), parseInt(selectedcan4.value)]
    }
...
const putJSON = () => {
    ...
    if (newRow.value.value.value[0] !== undefined) {
        if (newRow.value.value.value[0] === 1 || newRow.value.value.value[0] === 2 || newRow.value.value.value[0] === 4) {
            ...
            handleChange();
        } else if (newRow.value.value.value[0] === 4) {
            selected.value = newRow.value.value.value[0].toString();
