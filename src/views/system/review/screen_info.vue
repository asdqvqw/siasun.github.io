<template>
    <el-dialog v-model="dialogVisible2" title="屏幕2" custom-class="custom-dialog2">
        显示屏幕相关信息2
    </el-dialog>
...
const handleMouseClick = (car) => {
    ...
    if (intersects.length > 0) {
        ...
        if (intersects[0].object.name === 'screen'
            || intersects[0].object.name === 'Material_14车体4-113' || intersects[0].object.name === 'Material_18车体4-113'
            || intersects[0].object.name === 'Material_3车体4-113') {
